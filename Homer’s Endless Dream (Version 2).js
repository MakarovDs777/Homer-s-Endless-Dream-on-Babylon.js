  ...
  asteroids.push({asteroid: asteroid, vx: vx, vy: vy, vz: vz, radius: radius});
    ...
    // Определяем целевую позицию
            var targetPosition = new BABYLON.Vector3(
                asteroid.asteroid.position.x + asteroid.vx,
                asteroid.asteroid.position.y + asteroid.vy,
                asteroid.asteroid.position.z + asteroid.vz
            );
    ...
    // Линейная интерполяция между текущей и целевой позициями
            asteroid.asteroid.position = BABYLON.Vector3.Lerp(asteroid.asteroid.position, targetPosition, 0.1);
